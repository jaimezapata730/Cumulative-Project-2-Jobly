...
describe("findAll",  () => {
  ...
  test("works: No content found", async () => {
    let companies = await Company.findAll({ name: "nope" });
    expect(companies).toEqual([]);
  });

  test("Request denied if minimum is greater than maximum", async () => {
    try {
...
describe("get", function () {
  test("works", async function () {
    ...
    expect(company).toEqual({
      ...
      logoUrl: "http://c1.img",
      jobs: [
        { id: testJobsIds[0], title: "Job1", salary: 50, equity: "0.2"},
        { id: testJobsIds[1], title: "Job2", salary: 100, equity: "0.1"},
        { id: testJobsIds[2], title: "Job3", salary: 150, equity: "0"},
